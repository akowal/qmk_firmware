...
// ISRT, beakl, hands down
  ...
  [CTRL] = LAYOUT(
    XXXXXXX, XXXXXXX, RGB_HUI, RGB_VAI, RGB_SAI, RESET,          RESET,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, RGB_HUD, RGB_VAD, RGB_SAD, EEP_RST,        EEP_RST, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                               RGB_RMOD, RGB_TOG, RGB_MOD,       XXXXXXX, XXXXXXX, XXXXXXX,
                                         RGB_SPD, RGB_SPI,       XXXXXXX, XXXXXXX
  ),
  ...
  //                              XXXXXXX, XXXXXXX,        KC_ACL0, KC_ACL2
  // ),
